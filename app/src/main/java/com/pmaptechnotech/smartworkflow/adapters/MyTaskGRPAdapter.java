...
public class MyTaskGRPAdapter extends RecyclerView.Adapter<MyTaskGRPAdapter.MyViewHolder> {
    ...
    public MyTaskGRPAdapter(Context context, List<GrpToMe> chats) {
        this.chat = chats;
        this.context = context;
    }

    @Override
    public MyTaskGRPAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.getmygrptasks, parent, false);

        return new MyTaskGRPAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(MyTaskGRPAdapter.MyViewHolder holder, int position) {
